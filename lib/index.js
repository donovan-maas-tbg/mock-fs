...
const {resolveWin32, toNamespacedPathWin32} = require("./nodePath.js");
const fs = require('fs');
...
const realPathWin32Resolve = pathRaw.win32.resolve;
const realToNamespacedPathWin32 = pathRaw.win32.toNamespacedPath;
...
function overridePath() {
  pathRaw.win32.resolve = resolveWin32;
  pathRaw.win32.toNamespacedPath = toNamespacedPathWin32;
}

function restorePath() {
  pathRaw.win32.toNamespacedPath = realToNamespacedPathWin32;
  pathRaw.win32.resolve = realPathWin32Resolve;
}
